...
export default function InfoSection(props) {
    return (
        <section id="question" tabIndex="-1">
        <h2>What do I do?</h2>
        ...
        <p>If you're using a screen reader, you can use the visually hidden "Hear state of game" link in the navigation
            region to get a reminder of all your past guesses and how close your current guess is to being correct.
        </p>
        </section>
    );
}